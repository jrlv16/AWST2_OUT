# (AWS2_ENV) C:\AWS2Trial\AWST2_OUT>manage.py inspectdb
...
class Client(models.Model):
    cli_id = models.AutoField(db_column='CLI_ID', primary_key=True)  # Field name made
lowercase.
    cli_nom = models.CharField(db_column='CLI_NOM', max_length=50)  # Field name made lowercase.
    cli_prenom = models.CharField(db_column='CLI_PRENOM', max_length=50)  # Field name
made lowercase.
    ...
    suivi = models.ForeignKey('Suivi', models.DO_NOTHING, db_column='SUIVI_ID', blank=True, null=True)  # Field name made lowercase.
...
class Division(models.Model):
    division_id = models.AutoField(db_column='DIVISION_ID', primary_key=True)  # Field
name made lowercase.
...
class PagesBlockimg(models.Model):
    blkcontent = models.CharField(max_length=45)
    blkimg = models.CharField(max_length=100)
    blkitem = models.IntegerField()
    blkorder = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'pages_blockimg'
...
class PagesPageBlock(models.Model):
    page_id = models.IntegerField()
    blockimg_id = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'pages_page_block'
        unique_together = (('page_id', 'blockimg_id'),)
...
class Postes(models.Model):
    pos_id = models.AutoField(db_column='POS_ID', primary_key=True)  # Field name made
lowercase.
...
class Section(models.Model):
    sec_id = models.AutoField(db_column='SEC_ID', primary_key=True)  # Field name made
lowercase.
...
class Suivi(models.Model):
    suivi_id = models.AutoField(db_column='SUIVI_ID', primary_key=True)  # Field name made lowercase.
    cli_id = models.IntegerField(db_column='CLI_ID')  # Field name made lowercase.
    cli_nom = models.CharField(db_column='CLI_NOM', max_length=50)  # Field name made lowercase.
    cli_prenom = models.CharField(db_column='CLI_PRENOM', max_length=50)  # Field name
made lowercase.
    suivobs = models.ForeignKey('Suivobs', models.DO_NOTHING, db_column='SUIVOBS_ID', blank=True, null=True)  # Field name made lowercase.
...
class Suivobs(models.Model):
    ...
    suivobs_but = models.IntegerField(db_column='SUIVOBS_BUT', blank=True, null=True)
...
class TypeCli(models.Model):
    typ_id = models.AutoField(db_column='TYP_ID', primary_key=True)  # Field name made
lowercase.
...
(AWS2_ENV) C:\AWS2Trial\AWST2_OUT>